...
class ProfileVC: UIViewController, CAAnimationDelegate {
    ...
    private var progressLayer: ProfileVCViewLayer {
        get {
            return layer as! ProfileVC
        }
    }
    ...
    @IBInspectable public var glowMode: ProfileVCGlowMode = .forward {
        didSet {
    ...
    private class ProfileVCViewLayer: CALayer {
        ...
        var glowMode: ProfileVCGlowMode = .forward
        ...
        private enum GlowConstants {
            ...
            static func glowAmount(forAngle angle: Double, glowAmount: CGFloat, glowMode: ProfileVCGlowMode, size: CGFloat) -> CGFloat {
                switch glowMode {
                case .forward:
        ...
        override init(layer: Any) {
            ...
            let progressLayer = layer as! ProfileVCViewLayer
